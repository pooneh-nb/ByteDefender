...
async function insertScriptSource(newHttpReq, website) {
    const file = 'output/' + website + '/scripts.json';
...
app.post('/scriptSources', (req, res) => {
    insertScriptSource(req.body, website[0]);
